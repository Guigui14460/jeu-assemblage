...
public class DefaultPieceArrangement implements PieceArrangement {
    ...
    static {
        // Arrangement 1
        Arrangement arrangement1 = new Arrangement(5, 5);
        ...
        // Arrangement 2
        Arrangement arrangement2 = new Arrangement(7, 5);
        arrangement2.addPieces(new TPiece(0, 0, 3, 3), new RectanglePiece(3, 0, 1, 2), new RectanglePiece(0, 2, 1, 1));
        ...
        // Arrangement 3
        Arrangement arrangement3 = new Arrangement(13, 9);
        ...
        arrangement3.addPieces(new TPiece(0, 6, 5, 3), new InvertedLPiece(9, 2, 2, 2), new InvertedLPiece(4, 7, 2, 2),
        ...
        // Arrangement 4
        Arrangement arrangement4 = new Arrangement(10, 9);
        arrangement4.addPieces(new RectanglePiece(0, 5, 1, 1), new RectanglePiece(2, 7, 3, 1),
                new RectanglePiece(4, 1, 2, 2), new RectanglePiece(5, 0, 4, 1), new RectanglePiece(6, 7, 1, 2),
                new TPiece(0, 0, 3, 3), new TPiece(7, 2, 3, 7), new InvertedLPiece(5, 4, 2, 2), new LPiece(2, 1, 2, 5));

        // Arrangement 5
        Arrangement arrangement5 = new Arrangement(10, 10);
        arrangement5.addPieces(new LPiece(0, 1, 2, 3), new RectanglePiece(4, 0, 1, 1), new RectanglePiece(4, 3, 1, 1),
                new LPiece(6, 0, 2, 2), new RectanglePiece(6, 2, 2, 2), new InvertedLPiece(8, 0, 2, 3),
                new RectanglePiece(2, 4, 5, 2), new RectanglePiece(8, 3, 1, 4), new RectanglePiece(9, 4, 1, 1),
